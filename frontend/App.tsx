...
// Pages
import HomePage from "./src/_pages/index";
import ExplorePage from "./src/_pages/explore";
import CategoryPage from "./src/_pages/category";
import PatternPage from "./src/_pages/pattern";
import DemoPage from "./src/_pages/demo";
import EditorPage from "./src/_pages/editor";
import MyDemosPage from "./src/_pages/my-demos";
...
import TrendsPage from "./src/_pages/trends";
import TrendDetailPage from "./src/_pages/trend-detail";
import CreateTrendPage from "./src/_pages/create-trend";
import TrendReportPage from "./src/_pages/trend-report";
import TrendFlashPage from "./src/_pages/trend-flash";
import CodeFlashPage from "./src/_pages/code-flash";
import ProjectArchivePage from "./src/_pages/project-archive";
import ProjectDetailPage from "./src/_pages/project-detail";
import GameSelectPage from "./src/_pages/game-select";
import QuestionTypeSelectPage from "./src/_pages/question-type-select";
import GamePlayPage from "./src/_pages/game-play";
import GameSummaryPage from "./src/_pages/game-summary";
import LevelTestPage from "./src/_pages/level-test";
import ResourcesPage from "./src/_pages/resources";
import TrendResearchPage from "./src/_pages/trend-research";
import CommunityContestPage from "./src/_pages/community-contest";
import AdminReviewPage from "./src/_pages/admin-review";
import AdminDashboardPage from "./src/_pages/admin-dashboard";
import PlayPage from "./src/_pages/play";
import BuildPage from "./src/_pages/build";
import BuildEntryPage from "./src/_pages/build-entry";
import RoadmapGeneratorPage from "./src/_pages/roadmap-generator";
import PortfolioManagerPage from "./src/_pages/portfolio-manager";
import MyPage from "./src/_pages/mypage";
import NotificationsPage from "./src/_pages/notifications";
import PremiumPage from "./src/_pages/premium";
import AIGeneratePage from "./src/_pages/ai-generate";
import ResourceDetailPage from "./src/_pages/resource-detail";
import LearningHubPage from "./src/_pages/learning-hub";
